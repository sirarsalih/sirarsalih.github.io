...
<p><a href="http://sirars.files.wordpress.com/2014/03/capture.png"><img src="{{ site.baseurl }}/assets/capture.png" alt="Capture" width="440" height="313" class="alignnone size-full wp-image-353" /></a></p>
...
<p><img src="{{ site.baseurl }}/assets/webrole1.gif" alt="animation" width="527" height="112" /></p>
...
<p><img src="{{ site.baseurl }}/assets/properties.gif" alt="properties" width="568" height="194" /></p>
...
<p><a href="http://sirars.files.wordpress.com/2014/03/find_usages.png"><img src="{{ site.baseurl }}/assets/find_usages.png" alt="find_usages" width="440" height="499" class="alignnone size-full wp-image-370" /></a></p>
<p>ReSharper will show you a dialog where you can choose where to search:</p>
<p><a href="http://sirars.files.wordpress.com/2014/03/find_usages_2.png"><img src="{{ site.baseurl }}/assets/find_usages_2.png" alt="find_usages_2" width="440" height="354" class="alignnone size-full wp-image-372" /></a></p>
...
<p><a href="http://sirars.files.wordpress.com/2014/03/capture1.png"><img src="{{ site.baseurl }}/assets/capture1.png" alt="Capture" width="440" height="330" class="alignnone size-full wp-image-376" /></a></p>
<p>In final words, ReSharper is a wonderful refactoring tool that I will be using for years and years to come. That doesn't by any means make it perfect, and there are still features that I see lacking. Seeing how the ReSharper team is doing an incredible job developing the product (<a href="http://www.jetbrains.com/resharper/download/" title="ReSharper 8.2">ReSharper 8.2 was just released</a>), I'm not worried that they'll look into this and make our favorite tool even better. :)</p>
